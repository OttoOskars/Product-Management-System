    ...
    <div class="search-container">
        ...
        <div class="who-to-follow">
            ...
            <div class="people-container">
                <div class="person" v-for="(person, i) in people" :key="i">
                    <div class="user">
                            <div class="user-img">
                                <img :src="person.img" alt="" class="person-img"> 
                            </div>
                            <div class="user-info">
                                <p class="username">{{ person.name }}</p>
                                <p class="usertag">{{ person.username }}</p>
                            </div>
                        </div>
                    <div class="button-container">
                        <button class="follow-button" @click="handleFollow(i)" :class="{ 'followed-button': person.followed }">{{ person.followed ? 'Followed' : 'Follow' }}</button>
                    </div>
                </div>
                <!-- Add more people -->
            </div>
